...
class Database
{
    ...
    public:
        ...
        void update_user(const std::string &uuid,
                         ...
                         const std::string &email,
                         bool otp_is_enabled);
        void insert_credentials(const std::string &service_name, const std::string &username, const std::string &hash_passwd);
        void update_credentials(const std::string &service_name, const std::string &username, const std::string &hash_passwd);
